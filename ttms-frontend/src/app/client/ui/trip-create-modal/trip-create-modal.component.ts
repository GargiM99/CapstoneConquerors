...
import { ITripCreateDetails } from '../../data-access/types/trip/create-trip-details.interface';
...
export class TripCreateModalComponent implements IModal, OnInit{
  ...
  onCreate(){
    ...
    newTrip.clientId = this.inputValue 
  ...
  ngOnInit(): void {
    this.tripForm.patchValue({clientId: this.inputValue})
  }
